...
/**
 * Tests start export queue messages.
 */
final class StartExportMessageTest extends TestCase {
	public function test_constructor_stores_export_id_and_renderer_override(): void {
		$message = new StartExportMessage( 42, 'json' );
	...
	public function test_renderer_override_defaults_to_null(): void {
		self::assertNull( ( new StartExportMessage( 42 ) )->renderer_id );
	}
}
