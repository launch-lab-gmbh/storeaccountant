...
1. Öffnen Sie im WordPress-Backend `Plugins > Installierte Plugins`.
2. Klicken Sie bei StoreAccountant auf `Einstellungen`.
3. Wechseln Sie zum Tab `Diagnose`.
4. Aktivieren Sie die Diagnose-Protokollierung.
...
Die Berechtigungen für Diagnosefunktionen verwalten Sie unter
